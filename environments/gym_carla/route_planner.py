...
from environments.gym_carla.misc import distance_vehicle, is_within_distance_ahead, compute_magnitude_angle
...
class RoutePlanner():
  def __init__(self, vehicle, buffer_size):
    ...
    self._target_waypoint = carla.Transform(carla.Location(x=-7.694724, y=29.346333, z=2.000000),carla.Rotation(pitch=360.000000, yaw=79.971024, roll=0.000000))
