...
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=16, life_time=20)
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=15, life_time=20)#右1
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=14, life_time=20)#左
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=1089, life_time=20) #左上

#
lookwayponit.world.debug.draw_string(carla.Location(x=6.867558, y=-23.746708, z=0.000000), 'O', draw_shadow=False,
                                        color=carla.Color(r=0, g=255, b=0), life_time=200,
                                        persistent_lines=True)
lookwayponit.world.debug.draw_string(carla.Location(x=10.130323, y=-25.013346, z=0.000000), 'O', draw_shadow=False,
                                        color=carla.Color(r=0, g=255, b=0), life_time=200,
                                        persistent_lines=True)
#500到1000云盘无
# for i in range(1105,1106):#1100
#     lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=i, life_time=200)
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=30, life_time=200) #左上31，34，33
# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=38, life_time=200) #左上

# lookwayponit.draw_waypoints(lookwayponit.waypoints, road_id=1105, life_time=200)
